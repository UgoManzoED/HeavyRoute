...
class _RouteValidationDialogState extends State<RouteValidationDialog> {
  ...
  Future<void> _handleValidation(bool approved) async {
    ...
    // Attendiamo l'esecuzione della callback del padre
        ...
        child: Column(
          children: [
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text("Validazione Percorso ${widget.trip.tripCode}",
            ...
            Expanded(
              child: Row(
                children: [
                  // COLONNA SINISTRA: Controlli e Permessi
                  Container(
                    width: 350,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text("GESTIONE PERMESSI (Scenario 1)",
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.grey)),
                        const SizedBox(height: 12),

                        _buildCheckItem("Richiesta Nulla Osta ANAS", _anasPermissionRequested,
                                (val) => setState(() => _anasPermissionRequested = val!)),
                        _buildCheckItem("Notifica Polizia Stradale", _policePermissionRequested,
                                (val) => setState(() => _policePermissionRequested = val!)),
                        ...
                        if (_isProcessing)
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              ElevatedButton.icon(
                                // Abilita solo se i permessi sono checkati
                              ...
                              if (!_anasPermissionRequested || !_policePermissionRequested)
                                const Padding(
                                  padding: EdgeInsets.only(top: 8.0),
                                  child: Text("Richiedi i permessi per procedere.",
                                      textAlign: TextAlign.center, style: TextStyle(fontSize: 11, color: Colors.orange)),
                                )
                            ],
                          )
                      ],
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: const Text("Visualizzazione Punti Critici Attiva",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildRow(Icons.person, "Autista", "${widget.trip.driverName} ${widget.trip.driverSurname}"),
          const SizedBox(height: 8),
